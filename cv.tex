...
\item{\textbf{Topical Team Lead for LSST DESC} (2020 - Present): Manage scientific teams to develop software that accomplishes scientific goals within the collaboration.}
...
\vspace*{-0.3cm}
\item {\small $\bullet$} \textit{Python:} 9+ years of experience in using Python for coursework and several research projects, including comprehensive knowledge of its scientific computing stack: \texttt{numpy}, \texttt{scipy}, \texttt{scikit-learn},
\texttt{matplotlib}.
