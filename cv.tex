...
\begin{rSubsection}{Cosmic Shear Bayesian Pipeline}{Argonne National Laboratory, IL}{Matthew Becker (Weak Lensing)}{August 2024 -- Present}
...
\item Developing a new Bayesian cosmic shear measurement algorithm to be applied to LSST-like astronomical images.
\end{rSubsection}
